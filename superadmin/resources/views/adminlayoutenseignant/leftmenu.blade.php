          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a class="nav-link {{ Request::is('teachers') ? 'active':''; }}" href="{{ url('enseignantEtat') }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Etats des Enseignants</p>
                </a>
              </li>
                <li class="nav-item">
                <a class="nav-link {{ Request::is('teachers') ? 'active':''; }}" href="{{ url('enseignantposte') }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Postes des Enseignants</p>
                </a>
              </li>
                   <li class="nav-item">
                <a class="nav-link {{ Request::is('teachers') ? 'active':''; }}" href="{{ url('enseignantgrade') }}">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                <a class="nav-link {{ Request::is('attendancePersonnels') ? 'active':''; }}" href="{{ url('personnelEtat') }}">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a class="nav-link {{ Request::is('personnels') ? 'active':''; }}" href="{{ url('etudiantInscription') }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Inscription des étudiants</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ Request::is('postePersonnels') ? 'active':''; }}" href="{{ url('etudiantEtat') }}">
                  <i class="far fa-circle nav-icon"></i>
